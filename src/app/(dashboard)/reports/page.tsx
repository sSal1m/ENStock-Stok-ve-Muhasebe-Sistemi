...
const NAV_ITEMS = [
  ...
  { label: "Cari (Rehber)", icon: "group", href: "/contacts" },
  { label: "Raporlar", icon: "analytics", href: "/reports", active: true },
];
    ...
    return (
      <div className="p-10 flex flex-col items-center justify-center gap-4 text-center">
        <div className="animate-pulse flex flex-col items-center">
          <div className="h-10 w-10 rounded-xl bg-primary mb-4"></div>
  ...
  return (
    <div className="p-6 lg:p-10 space-y-8">
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 rounded-xl border border-indigo-100 bg-white px-4 py-2.5 text-sm font-medium text-slate-600 shadow-sm hover:border-primary/30 hover:shadow-md transition-all">
                <span className="material-symbols-outlined text-[18px] text-slate-400">calendar_today</span>
                {dateRange}
                <span className="material-symbols-outlined text-[16px] text-slate-400">expand_more</span>
              </button>
              <button className="flex items-center gap-2 rounded-xl bg-slate-100 border border-indigo-100 px-4 py-2.5 text-sm font-semibold text-slate-600 hover:bg-slate-200 active:scale-95 transition-all">
            ...
            <section className="grid grid-cols-1 gap-5 sm:grid-cols-3">
              {/* Toplam Gelir */}
              <div className="rounded-2xl bg-white border border-indigo-50/50 shadow-sm p-5 border-l-4 border-l-primary">
              ...
              {/* Toplam Gider */}
              <div className="rounded-2xl bg-white border border-indigo-50/50 shadow-sm p-5 border-l-4 border-l-slate-400">
                <div className="flex items-center justify-between mb-3">
            ...
            <section className="grid grid-cols-1 gap-5 lg:grid-cols-12">
              ...
              <div className="lg:col-span-8 rounded-2xl bg-white border border-indigo-50/50 shadow-sm overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                  {/* Gelir Kalemleri */}
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2 px-5 pt-5 pb-3 border-b border-indigo-50">
                      <span className="material-symbols-outlined text-primary text-[18px]">arrow_circle_up</span>
